...
<?php
	...
	default: ?>
		...
		<header><h2 class="tabs_involved">Daftar Kategori Materi</h2></header>
	...
	<?php
		...
		<tr><td><?php echo $no; ?></td>
			...
			<td><a href="?act=category&do=editkategori&id=<?php echo $r['id']; ?>"><img src="images/icn_edit.png" /></a>
				<a href="aksi.php?act=category&domateri=hapus&id=<?php echo $r['id']; ?>"><img src="images/icn_trash.png" /></a>
			</td>
		</tr>
		<?php $no++; } ?>
		</tbody>
			...
			<input class="button" type="button" align="left"value="Tambah Kategori" onClick=location.href="?act=category&do=addkategori">
...
<?php break; ?>
 ...
 <?php case "addkategori": ?>
		<article class="module width_3_quarter">
		<header><h3 class="tabs_involved">Tambah Kategori</h3></header>
		<div id="tab1" class="tab_content" style="display: block;">
		<table class="tablesorter" cellspacing="0">
...
<?php case "editkategori":
    ...
    <br class="clear" />
			<input class="button" type="button" value="Kembali" onClick=location.href="act_kategori.php">
<?php break; } ?>
